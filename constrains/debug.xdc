...
connect_debug_port u_ila_0/probe95 [get_nets [list {ipbus_payload/slave3/cfg_add_factor_t0[0]} {ipbus_payload/slave3/cfg_add_factor_t0[1]} {ipbus_payload/slave3/cfg_add_factor_t0[2]} {ipbus_payload/slave3/cfg_add_factor_t0[3]} {ipbus_payload/slave3/cfg_add_factor_t0[4]} {ipbus_payload/slave3/cfg_add_factor_t0[5]} {ipbus_payload/slave3/cfg_add_factor_t0[6]} {ipbus_payload/slave3/cfg_add_factor_t0[7]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe96 [get_nets [list {ipbus_payload/slave3/cfg_add_factor_t2[0]} {ipbus_payload/slave3/cfg_add_factor_t2[1]} {ipbus_payload/slave3/cfg_add_factor_t2[2]} {ipbus_payload/slave3/cfg_add_factor_t2[3]} {ipbus_payload/slave3/cfg_add_factor_t2[4]} {ipbus_payload/slave3/cfg_add_factor_t2[5]} {ipbus_payload/slave3/cfg_add_factor_t2[6]} {ipbus_payload/slave3/cfg_add_factor_t2[7]}]]
create_debug_port u_ila_0 probe
